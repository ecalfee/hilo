...
#SBATCH --mem=8G
#SBATCH --array=1-10
#SBATCH --export=MIN_cM=.0001,dir_in="var_sites/merged_pass1_all_alloMaize4Low_16/filteredAlloMAFnInd",dir_out="var_sites/merged_pass1_all_alloMaize4Low_16/thinnedHMM"
...
$(for i in $(awk -v chr=$i '$1 == chr {print $4}' refMaize/divide_50Mb/ALL_regions.list); \
