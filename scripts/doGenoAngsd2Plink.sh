...
#SBATCH -n 1
#SBATCH --array=0-425
#SBATCH --export=POP=maize.allo.4Low16,DIR_POPS=pass1_bam_pops,DIR_REGIONS=refMaize/divide_5Mb,DIR_SITES=var_sites/merged_pass1_all_alloMaize4Low_16/allVar,DIR_OUT=geno/merged_pass1_all_alloMaize4Low_16/allVar
...
-doPost 1 -postCutoff 0.99 -geno_minDepth 4
