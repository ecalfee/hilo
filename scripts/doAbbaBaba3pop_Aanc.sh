...
OUT_FILE=SAF/pass1/N1000.L100.regions
BAM_FILE=AbbaBaba/doAbbaBaba3pop_maize_bam.list
SIZE_FILE=AbbaBaba/doAbbaBaba3pop_maize.sizeFile
...
angsd -doAbbababa2 \
-Aanc 1 -rf $REGIONS -bam $BAM_FILE \
