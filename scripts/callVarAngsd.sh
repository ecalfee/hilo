...
-r REGION \
-doMajorMinor 4 -ref REFERENCE.fa \
...
# -baq 1 -minMapQ 30 -minQ 20: calculate BAQ adjusted quality score and filter out sites with low quality or low mapping
...
#angsd -GL 1 -ref /group/jrigrp/Share/assemblies/Zea_mays.AGPv4.dna.chr.fa -bam testBAM.list -r 1:10000-20000 -out testANGSD
	-> angsd version: 0.911 (htslib: 1.2.1-263-g2b2239a) build(Mar 11 2016 12:48:20)
	-> Reading fasta: /group/jrigrp/Share/assemblies/Zea_mays.AGPv4.dna.chr.fa
	-> fai index file: '/group/jrigrp/Share/assemblies/Zea_mays.AGPv4.dna.chr.fa.fai' looks older than corresponding fastafile: '/group/jrigrp/Share/assemblies/Zea_mays.AGPv4.dna.chr.fa'.
	-> Please reindex fasta file
# I need to index the reference, e.g.:
samtools faidx <ref.fa>
# I can either make a copy onto my local drive an index it or I can index the copy in the Share folder
