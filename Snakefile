...
rule all:
    input:
        ...
        "ancestry_by_r/tables/pearsons_rho_local_ancestry.tex",
        expand("ancestry_by_r/tables/pearsons_rho_f4_{POP}_{ALLO_MEX}.tex", POP = ["sympatric_maize", "sympatric_mexicana"], ALLO_MEX = "pop22"),
        ...
        expand("ZAnc/plots/Ne{Ne}_{YESNO}Boot/network_peak_sharing.png", Ne = 10000, YESNO = "yes"),
