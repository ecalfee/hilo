...
7) Summarize output of ancestry_hmm into individual and population ancestry frequencies:
calcAncfromPost.sh runs R script calc_genomewide_pop_anc_freq.R
and produces subdirectory anc/ to store results in output directory for ancestry_hmm posteriors
