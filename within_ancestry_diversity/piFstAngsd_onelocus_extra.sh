...
#SBATCH -J xpiFst1
#SBATCH -o /home/ecalfee/hilo/slurm-log/calcPiFst1locusextra_%A_%a.out
#SBATCH -t 24:00:00
#SBATCH -n 2
#SBATCH --mem=16G

# the first script piFstAngsd_onelocus.sh calculate pi and fst for one locus of interest
# using allopatric maize and allopatric mexicana homozygous for ancestry haplotypes
# this script does 'extras': gets theta for all the other haplotype groups and calculates Fst with parviglumis
# to run:
...
# loads angsd
module load bio
POPS=(parviglumis sympatric_maize.mexicana_hap sympatric_maize.maize_hap sympatric_mexicana.mexicana_hap sympatric_mexicana.maize_hap)
...
# allopatric maize and mexicana already completed in piFstAngsd_onelocus.sh
