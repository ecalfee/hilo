...
# txt_out = paste0("ZAnc/results/", prefix, "/K", K, "/Ne", Ne, "_", yesno, "Boot/flowering_time_genes_v4.plus20kb.overlap.summary_overlap_outliers.txt")

mex_maize = c("mexicana", "maize")
posneg = c("pos", "neg")
stats = c("mexicana_anc", "lmElev")
...
calc_pval = function(zea, sign, stat, sig, prefix, K, Ne, yesno){
  results_file = paste0("ZAnc/results/", prefix, "/K", K, "/Ne", Ne, "_", yesno, 
